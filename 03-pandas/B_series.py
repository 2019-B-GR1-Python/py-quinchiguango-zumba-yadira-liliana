...
# 1001 - 5000 10%
# 5001 - 20000 15%
#Funcion map transforma el arreglo en otro arreglo
#devuelve una nueva ciudad
def calculo(valor):
    if(valor <= 1000):
        return valor * 1.05
...
#se manda la funcion como parametro    
ciudad_calculada = ciudades_uno.map(calculo)

#Where excluye al que cumple la condicion
#Cuando no cumple la condicion aplica la formula
